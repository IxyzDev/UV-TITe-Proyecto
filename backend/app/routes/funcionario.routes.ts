...
import * as funcionarioController from '../controllers/funcionarios_controllers/funcionarios.controller';
...
router.post('/post', async (req: Request, res: Response) => {
  try {
    ...
    const newFuncionarioEntry = await funcionarioController.createFuncionario({...req.body});
...
router.put('/put/:id', async (req: Request, res: Response) => {
  try {
    await funcionarioController.updateFuncionario({ ...req.body, funcionario_ID: req.params.id });
...
router.delete('/delete/:id', async (req: Request, res: Response) => {
  try {
    await funcionarioController.deleteFuncionario({ funcionario_ID: req.params.id });
